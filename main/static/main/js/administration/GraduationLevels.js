                    ...
                    <tr>
                        ...
                        <td>
                            <div class="button-list">
                                ...
                                <button class="btn waves-effect waves-light btn-danger btn-sm" onclick="deleteSusGraduationLevel('${element.id}')" data-toggle="tooltip" title="Supprimer"><i class="mdi mdi-close "></i> </button>
                            </div>
                        </td>
                    </tr>
                `
...
function getSusGraduationLevel(id) {
    $.ajax({
        method: 'GET',
        url: `/GetSusGraduationLevelById/${id}/`,
        success: function(data) {
            if (data.status == true) {
                susGraduationForm.reset();
        ...
        success: function(data) {
            if (data.status == true) {
                swal({
                    ...
                    $.ajax({
                        method: 'GET',
                        url: `/DeleteSusGraduationLevel/${id}/`,
                        success: function(data) {
                            if (data.status == true) {
                                susGraduationForm.reset();
                                susGraduationLevelData.innerHTML = ""
